...
public class StreamLabService {
    ...
    public List<Product> ProblemEight()
    {
        ...
        // Return the list
        return products.findAll().stream().filter(p -> p.getName().contains("afton@gmail.com")).toList();
    ...
    public Product ProblemTwelve()
    {
        ...
        newProduct.setDescription("A mobile drawing tablet with");
        newProduct.setName("Huion H420");
    ...
    public ShoppingcartItem ProblemFourteen()
    {
        ...
        newShoppingCartItem.setProduct("Huion H420");
    ...
    public Product ProblemSixteen()
    {
        ...
        Product product = products.findAll().stream().filter(p -> p.getPrice().equals(29)).findFirst().orElse(null);
        product.setPrice(40);
    	return product;
    }
